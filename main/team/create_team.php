...
<head>
    ...
    <link href="/btechproject/css/bootswatch.css" rel="stylesheet">
  ...
  <body>
	...
	<div class="row">
		<div class="col-sm-8">
			<table id="mytable" class="table table-bordered table-hover">
				...
				<tbody>
                    ...
                    <?php
                      ...
                      $query="select tuser_id,name,status from request,account where fuser_id='$roll' AND request.tuser_id=account.rollno";
                        //echo $query;
			...
			<div class="col-sm-5">
				<input class="form-control" id="roll" name="rollno" type="text" placeholder="Ex. CB.EN.U4CSE13001"
